...
/**
 * The base box-shadow styles for the Hr Management Dashboard React.
 * You can add new box-shadow using this file.
 * You can customized the box-shadow for the entire Hr Management Dashboard React using thie file.
 */
